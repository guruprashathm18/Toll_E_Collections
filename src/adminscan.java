 ...
 * @author c.siva
 */
public class adminscan extends javax.swing.JFrame {

    private String q;

    /**
     * Creates new form adminscan
     */
    public adminscan()throws FileNotFoundException, IOException, NotFoundException, WriterException   {
        initComponents();
        scan();
//        this.setLocationRelativeTo(null);
    ...
    private void initComponents() {
        ...
        adminid.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        adminid.setText("jLabel3");

        verify.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(verify);
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGap(34, 34, 34)
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(tollname, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE)
...
String sql="select * from history where username='"+user+"'and toll_name='"+tollname.getText()+"'";
...
DefaultTableModel tblModel=(DefaultTableModel)verify.getModel();
...
System.out.println(ex);
 ...
 try{
int selectedRow = verify.getSelectedRow();
      DefaultTableModel model = (DefaultTableModel)verify.getModel();
        int i = verify.getSelectedRow();
        if(i >= -1)
        {
         //   model.setValueAt(verification.getText(), i, 7);
...
st.executeUpdate("UPDATE history SET verification='Paid/verified',date='"+date.getText()+"',time='"+time.getText()+"' WHERE username='"+username.getText()+"'and toll_name='"+tollname.getText()+"' and verification='Paid/not verified'");
st.close();
JOptionPane.showMessageDialog(null, "updated successfully"); 
    adminhistorycheck adminhistorycheck= new adminhistorycheck(); 
adminhistorycheck.setVisible(true);
adminhistorycheck.usrname.setText(username.getText());
...
public void scan()throws WriterException, IOException, NotFoundException{
...
//jLabel1.setText(dtf.format(now));
    ...
    public static void main(String args[]) throws WriterException, IOException, NotFoundException   {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(adminscan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//String u=username.setText(s);

        /* Create and display the form */
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new adminscan().setVisible(true);
                } catch (IOException ex) {
                    Logger.getLogger(adminscan.class.getName()).log(Level.SEVERE, null, ex);
...
time.setText(hour+":"+minute+":"+second);
    ...
    private javax.swing.JTable verify;
